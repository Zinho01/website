      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="bg-neutral-800 p-6 rounded-lg shadow-lg mb-8 text-left">
          ...
          <ul className="text-gray-400 space-y-4">
            <li>
              <strong>Acne behandeling:</strong> Intensieve reiniging die ontstekingen vermindert en de huid herstelt. Voorkomt toekomstige uitbraken.
            </li>
            <li>
              <strong>Pigment behandeling:</strong> Vervaagt pigmentvlekken en egaliseert de teint. Geschikt bij zonneschade en melasma.
            </li>
            <li>
              <strong>Micro dermabrasie:</strong> Mechanische peeling die dode huidcellen verwijdert. Verbetert structuur en laat de huid stralen.
            </li>
            <li>
              <strong>Dermapen:</strong> Microneedling stimuleert collageen en elastine. Vermindert littekens, lijntjes en poriën.
            </li>
            <li>
              <strong>Bio Peeling:</strong> Natuurlijke kruidenpeeling zonder huidbeschadiging. Stimuleert celvernieuwing en pakt huidproblemen aan.
            </li>
            <li>
              <strong>OxyGeneo:</strong> Exfolieert, voedt en activeert zuurstof. Geeft direct een glow en hydratatieboost.
            </li>
            <li>
              <strong>Gold treatment:</strong> Luxe behandeling met gouddeeltjes. Verstevigt de huid en geeft een gezonde glow.
            </li>
            <li>
              <strong>Anti-aging:</strong> Gaat huidveroudering tegen en hydrateert intensief. Verbetert elasticiteit en vermindert fijne lijntjes.
            </li>
            <li>
              <strong>Facial / Gezichtsbehandeling:</strong> Op maat gemaakte verzorging voor jouw huidtype. Combineert reiniging, voeding en ontspanning.
            </li>
          </ul>
        </div>
