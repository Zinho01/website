      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <h2 className="text-2xl font-semibold text-pink-300 mb-4">Onze Missie</h2>
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <h2 className="text-2xl font-semibold text-pink-300 mb-4">Onze Visie</h2>
            <p className="text-neutral-700 mb-4">
        ...
        <div className="mt-10">
          <h2 className="text-3xl font-bold mb-4 text-pink-300">Onze Diensten</h2>
        ...
        <div className="mt-10 border border-neutral-400 rounded-xl p-6 bg-white shadow-lg text-left">
          <h2 className="text-3xl font-bold mb-4 text-pink-300">Waarom Kiezen voor Onze Kliniek?</h2>
