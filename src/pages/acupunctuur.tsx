    ...
    <div className="bg-black text-white min-h-screen p-6">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="bg-neutral-800 p-6 rounded-lg shadow-lg text-left">
          <h2 className="text-2xl font-semibold text-gray-300 mb-4">Wat kan acupunctuur voor je betekenen?</h2>
        ...
        <motion.button 
            ...
            whileHover={{ scale: 1.05 }}>Boek een Gratis Consult
        </motion.button></a>

        <div className="bg-neutral-900 p-6 rounded-lg shadow-lg text-left mt-10">
